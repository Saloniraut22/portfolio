...
export const profile = {
  ...
  resume: asset("/resume/Saloni Raut Resume Latest.pdf"),
};
...
export const projects = [
  {
    ...
    team: "3 People",
    tools: ["Figma", "Miro"],
    coverImage: asset("/image/AI Sunglasses/Cover.png"),
    thumbnail: asset("/image/AI Sunglasses/Cover.png"),
    metrics: [
    ...
    seamlessSlices: [
      asset("/image/AI Sunglasses/Slice 2.png"),
      asset("/image/AI Sunglasses/Slice 3.png"),
      asset("/image/AI Sunglasses/Slice 4.png"),
      asset("/image/AI Sunglasses/Slice 5.png"),
      asset("/image/AI Sunglasses/Slice 6.png"),
      asset("/image/AI Sunglasses/Slice 7.png"),
      asset("/image/AI Sunglasses/Slice 8.png"),
      asset("/image/AI Sunglasses/Slice 9.png"),
    ],
  },
  {
    slug: "airaware",
    ...
    coverImage: asset("/image/airaware/cover.png"),
    thumbnail: asset("/image/airaware/cover.png"),
  ...
  },
  {
    ...
    category: "UI/UX Case Study",
    coverImage: asset("/image/Spendly/cover.png"),
    thumbnail: asset("/image/Spendly/cover.png"),
    ...
    seamlessSlices: [
      ...
      asset("/image/Spendly/service blueprint.jpg"),
      asset("/image/Spendly/story board.png"),
    ],
  },
];
